...
struct LunarLanderView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showLoadSheet) {
            LoadAgentSheet(environmentType: .lunarLander) { agent in
        ...
        VStack(spacing: 15) {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    case .charts:
                        LunarLanderChartsView(runner: runner)
        ...
        VStack(spacing: 12) {
            ...
            HStack(spacing: 16) {
                if runner.isTraining {
                    ...
                    .accessibilityHint("Begins training the Lunar Lander agent")
