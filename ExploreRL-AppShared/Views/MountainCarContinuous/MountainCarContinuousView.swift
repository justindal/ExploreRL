...
struct MountainCarContinuousView: View {
    ...
    var body: some View {
        mainContent
            ...
            .sheet(isPresented: $showLoadSheet) {
                LoadAgentSheet(environmentType: .mountainCarContinuous) { agent in
        ...
        VStack(spacing: 15) {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    case .charts:
                        MountainCarContinuousChartsView(runner: runner)
    ...
    private var chartsView: some View {
        ScrollView {
            MountainCarContinuousChartsView(
                runner: runner,
    ...
    private var controlButtons: some View {
        HStack(spacing: 16) {
            if runner.isTraining {
                ...
                .buttonStyle(TrainingButtonStyle(color: .purple))
                .accessibilityLabel(runner.canResume ? "Resume Training" : "Start Training")
                .accessibilityHint("Begins training the Mountain Car Continuous agent using SAC")
