...
struct PendulumView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showLoadSheet) {
            LoadAgentSheet(environmentType: .pendulum) { agent in
        ...
        VStack(spacing: 15) {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    case .charts:
                        PendulumChartsView(runner: runner)
        ...
        VStack(spacing: 12) {
            ...
            HStack(spacing: 16) {
                if runner.isTraining {
                    ...
                    .buttonStyle(PendulumTrainingButtonStyle(color: .red))
                    ...
                    .buttonStyle(PendulumTrainingButtonStyle(color: .indigo))
                    .accessibilityLabel(runner.canResume ? "Resume Training" : "Start Training")
                    .accessibilityHint("Begins training the Pendulum agent")
                    ...
                    .buttonStyle(PendulumTrainingButtonStyle(color: Color(.systemGray)))
...
struct PendulumTrainingButtonStyle: ButtonStyle {
    let color: Color
